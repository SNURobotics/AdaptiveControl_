function [dot_state_augmented] = Dynamics_Adaptive_sample(t, state_augmented, robot, A)
...
[q_desired, q_desired_dot, q_desired_ddot] = make_desired_trajectory_sample(t, A, robot);
