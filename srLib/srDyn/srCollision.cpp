...
bool srCollision::_RayToBox(Vec3& point, Vec3& direction, SR_real& range, SR_real& dist)
{
	...
	memcpy(&A[0],&q1[0],sizeof(SR_real)*3);	//memcpy(&A(0,0),&q1[0],sizeof(real)*3);
	memcpy(&A[3],&q2[0],sizeof(SR_real)*3);	//memcpy(&A(0,1),&q2[0],sizeof(real)*3);
	memcpy(&A[6],&q3[0],sizeof(SR_real)*3);	//memcpy(&A(0,2),&q3[0],sizeof(real)*3);

	static SR_real B[3];						//static RMatrix B(3,1);
	memcpy(&B[0],&p1[0],sizeof(SR_real)*3);	//memcpy(&B(0,0),&p1[0],sizeof(real)*3);
	...
	memcpy(&PC[0],&v[0],sizeof(SR_real)*3);	//memcpy(&C(0,0),&v[0],sizeof(real)*3);
